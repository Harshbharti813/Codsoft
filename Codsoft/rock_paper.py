...
Label(text = 'RPS Game', font = font.Font(size = 20), bg = '#FFA500').pack()
...
winner_label = Label(text = "", fg = 'green', bg = '#FFA500', font = font.Font(size = 13), pady = 8)
winner_label.pack()

input_frame = Frame(root, bg = '#FFA500')
input_frame.pack()

#Displaying player options
player_options = Label(input_frame, text = "Your Options : ", font = app_font, fg = 'white', bg = '#FFA500')
...
score_label = Label(input_frame, text = 'Score : ', font = app_font, fg = 'white', bg = '#FFA500')
score_label.grid(row = 2, column = 0)

player_choice_label = Label(input_frame, text = 'Your Selected : ---', font = app_font, bg = '#FFA500')
player_choice_label.grid(row = 3, column = 1, pady = 5)

player_score_label = Label(input_frame, text = 'Your Score : 0', font = app_font, bg = '#FFA500')
